package com.seazen.kafka.service.impl;

import com.seazen.kafka.bean.XyKafkaOutMsg;
import com.seazen.kafka.constant.RunStatus;
import com.seazen.kafka.constant.Topic;
import com.seazen.kafka.dao.XyKafkaOutMsgMapper;
...
//        }
    ...
    @Override
    public synchronized String  getMsgFast(){
